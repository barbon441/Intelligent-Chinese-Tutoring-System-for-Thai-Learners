...
> **อ่านคู่กับ:** `HANDOFF-จีนรู้ใจ.md` (ภาพรวม) · `01_เอกสารโครงงาน/ข้อเสนอโครงงาน-ฉบับแก้ไข-โฟกัสHSK.md` (ขอบเขต 8 โมดูล) · โน้ตใน `07_คลังความรู้-Obsidian/`
>
...
- ⚠️ ใช้ **Serwist เท่านั้น** — ห้ามใช้ next-pwa (เลิกพัฒนาแล้ว) — ดู `07_คลังความรู้-Obsidian/10-เทคโนโลยี/Next.js-PWA.md`
...
> โค้ดอยู่ repo `github.com/barbon441/Intelligent-Chinese-Tutoring-System-for-Thai-Learners` — โฟลเดอร์เอกสาร 01–07 เดิมคงอยู่ เพิ่มส่วนโค้ดดังนี้
...
- เอกสารภาษาไทยอยู่โฟลเดอร์ 01–07 ตามเดิม · **ห้ามสร้างไฟล์สำเนา `(1)`/`ฉบับใหม่2` — แก้ในไฟล์เดิม** (กติกาทีม)

---

## 9. Decision Log ย่อ

| # | การตัดสินใจ | เหตุผลสั้น | โน้ตอ้างอิง (07_คลังความรู้-Obsidian) |
|---|---|---|---|
