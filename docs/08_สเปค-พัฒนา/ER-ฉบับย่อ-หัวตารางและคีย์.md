...
>
> 🖼️ **ต้องการรูปไปใส่เล่ม/โปสเตอร์ → เปิด [`ER-ฉบับย่อ-星航.drawio`](ER-ฉบับย่อ-星航.drawio) ใน draw.io** — มี **8 หน้า** ดูแท็บล่างจอ (ภาพรวม 2 แบบ + เดินตามผู้ใช้ 6 ก้าว ตรงกับหัวข้อในไฟล์นี้)
...
>
> **ใช้หน้าไหนตอนไหน:** อธิบายหน้าห้อง/ซ้อมตอบ → ใช้หน้าก้าวที่ 1-6 ทีละหน้า (หน้าละไม่กี่กล่อง เส้นแทบไม่ตัดกัน) · ใส่เล่มหรือโปสเตอร์ → ใช้หน้า "ภาพรวมทั้งระบบ" (จัดให้เส้นตัดกันน้อยสุด) · **ชี้เล่าทั้งระบบในหน้าเดียวตามลำดับที่อาจารย์สอน → ใช้หน้า "ภาพรวม · เดินตามผู้ใช้"** (เพิ่ม 3 ก.ย. ตามที่บอลขอ — 5 คอลัมน์ซ้าย→ขวา: คน → เนื้อหา → ข้อสอบ → การทำแต่ละครั้ง → สมอง ยอมให้เส้นตัดกันเพิ่มแลกกับไล่เล่าได้)
